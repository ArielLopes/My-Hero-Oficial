package com.ariellopes.myhero.enuns;

public enum TipoSanguinio {

		A_POSITIVO(1, "A+"), A_NEGATIVO(2, "A-"), B_POSITIVO(3, "B+"), B_NEGATIVO(4, "B-"), AB_POSITIVO(5, "AB+"),
		AB_NEGATIVO(6, "AB-"), O_POSITIVO(7, "O+"), O_NEGATIVO(8, "O-");
